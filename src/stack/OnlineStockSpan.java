...
public class OnlineStockSpan {
	...
	public static void main(String[] args) {
		...
		System.out.print(oss.next(100));// return 1
		System.out.print(oss.next(80)); // return 1
		System.out.print(oss.next(60)); // return 1
		System.out.print(oss.next(70)); // return 2
		System.out.print(oss.next(60)); // return 1
		System.out.print(oss.next(75)); // return 4, because the last 4 prices (including today's price of 75) were less than or equal to today's price.
		System.out.print(oss.next(85)); // return 6.next(100); // return 1
 ...
 * 
 * Output: [null, 1, 1, 1, 2, 1, 4, 6] Explanation: StockSpanner stockSpanner =
 * new StockSpanner(); stockSpanner.next(100); // return 1
 * stockSpanner.next(80); // return 1 stockSpanner.next(60); // return 1
 * stockSpanner.next(70); // return 2 stockSpanner.next(60); // return 1
